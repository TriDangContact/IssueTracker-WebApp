...
class Page extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async componentDidMount() {
    ...
    console.log(`Retrieved Data: signedIn: ${signedIn}, givenName: ${givenName}`);
    this.setState({
      user: {
        signedIn,
        givenName
...
//# sourceMappingURL=server.8d8cf2b636a24938bd71.hot-update.js.map